          ...
          <div class="layer-text">
            <div class="page-left-2">
              ...
              <div class="page-text w-richtext">
                <h3><strong v-html="argomenti['advice'].title_es"></strong></h3>
                <span v-html="argomenti['advice'].link_es"></span>
                <span v-html="argomenti['advice'].content_es"></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="right-side">
          ...
          <div class="layer-text right">
            <div class="page-right-2">
              <div class="page-text w-richtext">
                <h3><strong v-html="argomenti['advice'].title_it"></strong></h3>
                <span v-html="argomenti['advice'].link_it"></span>
                <span v-html="argomenti['advice'].content_it"></span>
              </div>
            </div>
          </div>
        </div>
