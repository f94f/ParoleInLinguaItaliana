          ...
          <div class="layer-text">
            <div class="page-left-2">
              ...
              <div class="page-text w-richtext">
                <h3><strong v-html="argomenti['courses'].title_es"></strong></h3>
                <span v-html="argomenti['courses'].link_es"></span>
                <span v-html="argomenti['courses'].content_es"></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="right-side">
          ...
          <div class="layer-text right">
            <div class="page-right-2">
              <div class="page-text w-richtext">
                <h3><strong v-html="argomenti['courses'].title_it"></strong></h3>
                <span v-html="argomenti['courses'].link_it"></span>
                <span v-html="argomenti['courses'].content_it"></span>
              </div>
            </div>
          </div>
        </div>
...
<style scoped>
  ...
  @media (min-width: 1130px) {
    ...
    .book-cover-left {
      ...
      background-color: #221b59;
      box-shadow: inset 4px -4px 4px 1px #221b59, inset 7px -7px 4px 0 #221b59;
      -webkit-perspective: 4000px;
      perspective: 4000px;
